...
export default function Register() {
  ...
  // Simple client-side email validation to guide users before submitting
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Normalize and validate email before submitting
      const normalizedEmail = (formData.email || '').trim().toLowerCase();
      if (!isValidEmail(normalizedEmail)) {
        setError('Email không hợp lệ. Vui lòng nhập lại theo dạng ten@tenmien.com');
        return;
      }
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onInvalid={(e) => e.target.setCustomValidity('Email phải có dạng ten@tenmien.com. Vui lòng nhập lại.')}
